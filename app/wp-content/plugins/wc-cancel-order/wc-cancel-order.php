...
class WC_Cancel_Order{
    ...
    function wc_cancel_request_order_status()    {
        register_post_status('wc-cancel-request', array('label' => 'Запрос отмены', 'public' => true, 'exclude_from_search' => false, 'show_in_admin_all_list' => true, 'show_in_admin_status_list' => true, 'label_count' => _n_noop('Cancel Request <span class="count">(%s)</span>', 'Cancel Request <span class="count">(%s)</span>')));
    }
    ...
    function add_wc_cancel_request_to_order_statuses($order_statuses)    {
        ...
        foreach ($order_statuses as $key => $status) {
            ...
            if ('wc-processing' === $key) {
                $new_order_statuses['wc-cancel-request'] = __('Запрос отмены','wc-cancel-order');
            }
